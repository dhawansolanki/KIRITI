...
function submit_form1(){
 ...
 window.open( 
   ...
   function submit_form2(call=0){
    ...
    console.log("clicked", (/^[a-zA-Z]+$/.test(name)));
 ...
 xhr.open("POST", "https://submit-form.com/mfv3uasO");
...
if (call==0)
 window.open( 
    ...
    window.location = "https://s3.ap-south-1.amazonaws.com/www.northerncolumbia.in/KIRITI_BROCHURE.pdf";
}
}
